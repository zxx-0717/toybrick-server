...
![](../socket_test/docs/imgs/nanodet-plus-arch.png)
...
Find more update notes in [Update notes](../socket_test/docs/update.md).
## Demo

### Android demo

![android_demo](../socket_test/docs/imgs/Android_demo.jpg)
...
2. **Prepare config file**
    ...
    If you want to modify network, data augmentation or other things, please refer to [Config File Detail](../socket_test/docs/config_file_detail.md)
